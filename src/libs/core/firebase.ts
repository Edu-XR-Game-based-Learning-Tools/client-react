...
export const getQuizStorageRef = (postLocation: string = '') =>
  ref(cloudStorage, `/quiz-file-upload${postLocation ? `/${postLocation}` : ''}`)

export const onDownloadXRApp = () => {
  const link = document.createElement('a')
  link.download = `GBLT.apk`
  link.href =
    'https://dl.dropboxusercontent.com/scl/fi/882icfke5yv7s885shy6o/com.tom.csun.apk?rlkey=6id2kmjlptrl7d9ak24n6v3uc&dl=0'
